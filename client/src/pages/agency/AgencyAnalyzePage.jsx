...
export default function AgencyAnalyzePage() {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (selectedPlatform === 'facebook') {
          ...
          setValue('communityCount', 50);
          setValue('urlsShared', Math.round((data.post_count || 0) * 0.3));
          setValue('photosVideos', Math.round((data.post_count || 0) * 0.7));
        }

        if (selectedPlatform === 'twitter') {
          setValue('tweetCount', data.post_count || 0);
          setValue('likesCount', 100);
          setValue('listsCount', 1);
          setValue('hasHeaderPic', true);
        }
  ...
  const getVerdictMessage = (verdict) => {
    switch (verdict) {
      ...
      case 'suspicious': return 'This profile has some suspicious characteristics that warrant investigation.';
  ...
  return (
    <Layout title="Investigation Analyzer" subtitle="Agency Profile Investigation Tool">
      {error && (
      ...
      {scraped && (
        <div className="alert-banner success">
          ...
          <div className="alert-text">
            <strong>Profile data retrieved successfully!</strong> Review the data and proceed with analysis.
          </div>
        </div>
      )}
            ...
            <div className="panel">
              <div className="panel-header">
                <div className="panel-title">
                  🔍 {selectedPlatform.charAt(0).toUpperCase() + selectedPlatform.slice(1)} Subject Profile
                </div>
                <div className="panel-count">Enter URL to auto-fetch or input manually</div>
              </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div className="form-group">
                    ...
                    <span style={{ fontSize: '11px', color: 'var(--text-dim)', marginTop: '4px' }}>
                      Enter profile URL and click "Auto-Fill" to retrieve data automatically
                    </span>
                  </div>
      ...
      {step === 2 && result && (
        <div className="two-col">
          ...
          <div className={`result-card ${getVerdictClass(result.verdict)}`}>
            ...
            <div className="result-actions">
              <button className="btn btn-primary" onClick={submitReport} disabled={submitting}>
                {submitting ? 'Creating Case...' : '📋 Create Case Report'}
              </button>
          ...
          <div className="panel">
            <div className="panel-header">
              <div className="panel-title">🧠 AI Analysis Breakdown</div>
            </div>
